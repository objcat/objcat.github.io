...
顺便介绍一下白猫的「终身学习制度」, 白猫认为`找工作`和`学技术`并不存在什么联系, 换句话来说白猫学习的各类技术都不是为了找工作来学习的, 而是出于本心中最原始的`爱好`, 所以白猫才提出了终身学习制度以对抗这个世界上比自己强的人, 无论是从学历上还是技术上, 只要有任何一个对手在原地踏步, 那么就会成为白猫这项制度的「猎物」
