...
首先配置好你们的证书和描述文件
![](https://upload-images.jianshu.io/upload_images/2194379-6b2802ef5a7f65ae.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/2194379-89d1ba1c2cefe93d.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

出现上面的画面说明编译成功了 如图所示可以查到到当中的编译文件生成路径 我们追过去看看吧
![](https://upload-images.jianshu.io/upload_images/2194379-9863cbe5ae28bd13.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

我们可以看到`.app`文件就是经过上面命令编译生成的, 证书和描述文件都记录在`TestPackage.xcodeproj `里面, 所以都是自动选择的, 我们来看一看它的签名 
**右键** -> **显示包内容**

![](https://upload-images.jianshu.io/upload_images/2194379-bc6213e7b7e6fe63.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/2194379-39734a32ccff4c73.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
这个呢
![](https://upload-images.jianshu.io/upload_images/2194379-7969c615d56ed2e2.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

到这里你应该可以明白了, 你每次打包都会生成这么一个归档文件, 并且会以列表的形式显示出来, 这其实就是`Archive `文件, 它用来记录你的每次打包记录, 我先现在就看一看他在哪, 右键 `show in finder`
![](https://upload-images.jianshu.io/upload_images/2194379-2e6ce7ef86d8c414.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)


我们可以看到这个灰色图标的文件就是我们归档的包, 我们右键`显示包内容`来参观一下
![](https://upload-images.jianshu.io/upload_images/2194379-decb2d2dd0ee5646.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
```
归档完成后就是这样
![](https://upload-images.jianshu.io/upload_images/2194379-2d1a4e40c634489f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

我们可以看到`归档`这个命令和`编译`差不多, 只是多了一个`-archivePath`归档路径和一个`archive`表示归档的命令

之后我们双击看看吧

![](https://upload-images.jianshu.io/upload_images/2194379-958003eaccdff915.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![](https://upload-images.jianshu.io/upload_images/2194379-cd898311b907e566.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
我们上传`AppStore`试试
![](https://upload-images.jianshu.io/upload_images/2194379-3a94ae7ff4a1d55f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

![](https://upload-images.jianshu.io/upload_images/2194379-9669402e8f8de613.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

我们可以看到, 包是上传成功的, 证明这种打包方法是完全有效并且正规的.

之后我们去`AppStore Connect`查看一下吧
![](https://upload-images.jianshu.io/upload_images/2194379-a13491bcdaf81454.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

我们可以看到 项目已经在上面了 接下来我们就是用`TestFlight`来测试一下吧!

![](https://upload-images.jianshu.io/upload_images/2194379-d8ae999e0560f64d.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

![](https://upload-images.jianshu.io/upload_images/2194379-4008648cdf5812a5.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

![](https://upload-images.jianshu.io/upload_images/2194379-58361dc36bd3c093.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

能在手机上运行可以证明这种方法是完全正确的.

之后我们对脚本进行一下优化, 试想有这样一种情况, 你有很多的app, 你不会为所有的应用都分别写一个脚本, 这样岂不是太麻烦了, 所以这里我们使用脚本传参的方式来优化一下.

![](https://upload-images.jianshu.io/upload_images/2194379-d594607b6c1716e5.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![image.png](https://upload-images.jianshu.io/upload_images/2194379-bb20d8b13c793d52.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

发现是可以打包成功的, 到这里已经实现了脚本自动打包了, 而且是官方正规方法, 那么接下来, 你有可能还是觉得不爽, 每次都执行这个命令行也太麻烦了! 这里提供一种解决方案使用`Alfred`的`Workflows`来执行脚本

![](https://upload-images.jianshu.io/upload_images/2194379-8082294e3af41fde.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

![](https://upload-images.jianshu.io/upload_images/2194379-8e7274e987e4ccdc.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

![](https://upload-images.jianshu.io/upload_images/2194379-6f24cd955684e18d.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

![](https://upload-images.jianshu.io/upload_images/2194379-53624540fdfc3acd.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

![](https://upload-images.jianshu.io/upload_images/2194379-d68b0abfafe67fbf.gif?imageMogr2/auto-orient/strip)
