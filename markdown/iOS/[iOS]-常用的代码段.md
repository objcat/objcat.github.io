...
![](./images/3ccc327bd561a4b56ef00f5e6a5b4a01/1.png)
...
![](./images/3ccc327bd561a4b56ef00f5e6a5b4a01/2.png)
...
![](./images/3ccc327bd561a4b56ef00f5e6a5b4a01/3.png)


我们就来设置一下

![](./images/3ccc327bd561a4b56ef00f5e6a5b4a01/4.png)

我们这么设置完之后, 点任意地方关闭设置窗口, 然后直接在代码中打出`table`就可以看见我们的代码了, 是不是非常简单呢?

如果想要修改我们的代码段, 可以点击这里呼出代码段的设置界面

![](./images/3ccc327bd561a4b56ef00f5e6a5b4a01/5.png)
...
![](./images/3ccc327bd561a4b56ef00f5e6a5b4a01/6.png)
