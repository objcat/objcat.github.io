...
首先配置好你们的证书和描述文件
![](./images/7ecfc8a897ef72936f98b093018ff2f5/1.png)
...
![](./images/7ecfc8a897ef72936f98b093018ff2f5/2.png)

出现上面的画面说明编译成功了 如图所示可以查到到当中的编译文件生成路径 我们追过去看看吧
![](./images/7ecfc8a897ef72936f98b093018ff2f5/3.png)

我们可以看到`.app`文件就是经过上面命令编译生成的, 证书和描述文件都记录在`TestPackage.xcodeproj `里面, 所以都是自动选择的, 我们来看一看它的签名 
**右键** -> **显示包内容**

![](./images/7ecfc8a897ef72936f98b093018ff2f5/4.png)
...
![](./images/7ecfc8a897ef72936f98b093018ff2f5/5.png)
这个呢
![](./images/7ecfc8a897ef72936f98b093018ff2f5/6.png)

到这里你应该可以明白了, 你每次打包都会生成这么一个归档文件, 并且会以列表的形式显示出来, 这其实就是`Archive `文件, 它用来记录你的每次打包记录, 我先现在就看一看他在哪, 右键 `show in finder`
![](./images/7ecfc8a897ef72936f98b093018ff2f5/7.png)


我们可以看到这个灰色图标的文件就是我们归档的包, 我们右键`显示包内容`来参观一下
![](./images/7ecfc8a897ef72936f98b093018ff2f5/8.png)
...
```
归档完成后就是这样
![](./images/7ecfc8a897ef72936f98b093018ff2f5/9.png)

我们可以看到`归档`这个命令和`编译`差不多, 只是多了一个`-archivePath`归档路径和一个`archive`表示归档的命令

之后我们双击看看吧

![](./images/7ecfc8a897ef72936f98b093018ff2f5/10.png)
...
![](./images/7ecfc8a897ef72936f98b093018ff2f5/11.png)
...
我们上传`AppStore`试试
![](./images/7ecfc8a897ef72936f98b093018ff2f5/12.png)

![](./images/7ecfc8a897ef72936f98b093018ff2f5/13.png)

我们可以看到, 包是上传成功的, 证明这种打包方法是完全有效并且正规的.

之后我们去`AppStore Connect`查看一下吧
![](./images/7ecfc8a897ef72936f98b093018ff2f5/14.png)

我们可以看到 项目已经在上面了 接下来我们就是用`TestFlight`来测试一下吧!

![](./images/7ecfc8a897ef72936f98b093018ff2f5/15.png)

![](./images/7ecfc8a897ef72936f98b093018ff2f5/16.png)

![](./images/7ecfc8a897ef72936f98b093018ff2f5/17.png)

能在手机上运行可以证明这种方法是完全正确的.

之后我们对脚本进行一下优化, 试想有这样一种情况, 你有很多的app, 你不会为所有的应用都分别写一个脚本, 这样岂不是太麻烦了, 所以这里我们使用脚本传参的方式来优化一下.

![](./images/7ecfc8a897ef72936f98b093018ff2f5/18.png)
...
![](./images/7ecfc8a897ef72936f98b093018ff2f5/19.png)

发现是可以打包成功的, 到这里已经实现了脚本自动打包了, 而且是官方正规方法, 那么接下来, 你有可能还是觉得不爽, 每次都执行这个命令行也太麻烦了! 这里提供一种解决方案使用`Alfred`的`Workflows`来执行脚本

![](./images/7ecfc8a897ef72936f98b093018ff2f5/20.png)

![](./images/7ecfc8a897ef72936f98b093018ff2f5/21.png)

![](./images/7ecfc8a897ef72936f98b093018ff2f5/22.png)

![](./images/7ecfc8a897ef72936f98b093018ff2f5/23.png)

![](./images/7ecfc8a897ef72936f98b093018ff2f5/24.png)
