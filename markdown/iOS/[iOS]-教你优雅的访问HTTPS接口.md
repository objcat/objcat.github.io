...
![](./images/bbe4dfb9910c2e2f35724858a64695f5/1.png)
...
![](./images/bbe4dfb9910c2e2f35724858a64695f5/2.png)
...
![](./images/bbe4dfb9910c2e2f35724858a64695f5/3.png)
...
![](./images/bbe4dfb9910c2e2f35724858a64695f5/4.png)
...
![](./images/bbe4dfb9910c2e2f35724858a64695f5/5.png)

好了下面我们就来申请一个免费的证书吧!

首先去阿里云或别的机构申请CA证书, 这里举例申请一个免费的.

![](./images/bbe4dfb9910c2e2f35724858a64695f5/6.png)

阿里云控制台 -> 产品与服务 -> 搜索ssl

![](./images/bbe4dfb9910c2e2f35724858a64695f5/7.png)

![](./images/bbe4dfb9910c2e2f35724858a64695f5/8.png)

可以看到证书很贵, 这里面有一个免费的, 但是点出来需要点技巧

![](./images/bbe4dfb9910c2e2f35724858a64695f5/9.png)

之后选择支付就可以了, 支付完成会发现多了个证书

![](./images/bbe4dfb9910c2e2f35724858a64695f5/10.png)

![](./images/bbe4dfb9910c2e2f35724858a64695f5/11.png)


填写基本信息

![](./images/bbe4dfb9910c2e2f35724858a64695f5/12.png)
...
![](./images/bbe4dfb9910c2e2f35724858a64695f5/13.png)

我们可以看到证书审核好了, 我们就可以直接配置了, 首先把证书下载下来, 密码在同目录的文本文件里, 然后开始配置, 这里以`springcloud`为例

下载后的证书是`pfx`格式的, 我们先把它导入钥匙串, 然后导出为`p12`文件

![](./images/bbe4dfb9910c2e2f35724858a64695f5/14.png)

![](./images/bbe4dfb9910c2e2f35724858a64695f5/15.png)

然后把证书放到`resources`目录下, 我改了个名请忽略 - -

![](./images/bbe4dfb9910c2e2f35724858a64695f5/16.png)
...
![](./images/bbe4dfb9910c2e2f35724858a64695f5/17.png)

我们可以看到证书是有效的, 这个服务器是配置在我本地的, 我们用ip来访问一下.

![](./images/bbe4dfb9910c2e2f35724858a64695f5/18.png)

我们会发现, 同样的接口, 把域名换成ip就不可以访问了, 这也验证了我们DV证书是校验域名的这个原理.

我们可以直接在证书上查看我们信任的域名

![](./images/bbe4dfb9910c2e2f35724858a64695f5/19.png)
...
![](./images/bbe4dfb9910c2e2f35724858a64695f5/20.png)
...
![](./images/bbe4dfb9910c2e2f35724858a64695f5/21.png)

双击证书, 输入密码就能导入钥匙串了, 我们来看看

![](./images/bbe4dfb9910c2e2f35724858a64695f5/22.png)

这个证书的使用方法和CA证书一样
1.放在`resources`目录下
2.填写配置文件 - 参考CA证书配置

![](./images/bbe4dfb9910c2e2f35724858a64695f5/23.png)
...
![](./images/bbe4dfb9910c2e2f35724858a64695f5/24.png)

之后点击继续前往

![](./images/bbe4dfb9910c2e2f35724858a64695f5/25.png)

这样虽然可以访问, 但是我们可以看到上面写的三个红色的大字, 不安全, 所以我们需要解决一下这个问题, 就是信任证书!

![](./images/bbe4dfb9910c2e2f35724858a64695f5/26.png)

我们发现信任证书之后`safari`是可以访问通的, 但是`chrome`还是会报错不安全

![](./images/bbe4dfb9910c2e2f35724858a64695f5/27.png)

![](./images/bbe4dfb9910c2e2f35724858a64695f5/28.png)
...
![](./images/bbe4dfb9910c2e2f35724858a64695f5/29.png)
